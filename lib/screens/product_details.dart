...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  buildDynamicLinks(String title,String image,String docId) async {
    String url = "https://onatcipli.page.link";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: url,
      link: Uri.parse('$url/$docId'),
      androidParameters: AndroidParameters(
        packageName: "com.onatcipli.kzamiza",
        minimumVersion: 0,
      ),
  ...
  buildDynamicLinkscoby(String title,String image,String docId) async {
    String url = "https://onatcipli.page.link";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: url,
      link: Uri.parse('$url/$docId'),
      ...
      iosParameters: IosParameters(
        bundleId: "com.onatcipli.kzamiza",
        minimumVersion: "0",
      ),
      socialMetaTagParameters: SocialMetaTagParameters(
          description: '',
    ...
    String desc = '${dynamicUrl.shortUrl.toString()}';
    await   SocialShare.copyToClipboard(desc);
        print(desc);
  }
  onCopyTap(setState) {
    setState(() {
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                            onCopyTap(setState);
                            buildDynamicLinkscoby(_productDetails.name,_productDetails.thumbnail_image,_productDetails.id.toString(),);
                          },
                        ),
                      ),
                      _showCopied
