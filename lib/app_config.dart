...
class AppConfig {
  static String copyright_text = "@ kzamiza " + this_year; //this shows in the splash screen
  static String app_name = "kzamiza"; //this shows in the splash screen
  ...
  static const DOMAIN_PATH = "kzamiza.net"; //inside a folder
