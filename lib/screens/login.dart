...
class _LoginState extends State<Login> {
  ...
  onPressedTwitterLogin() async {
    try {
      ...
      print("auth 1  ${authResult.errorMessage}");
      var loginResponse = await AuthRepository().getSocialLoginResponse("twitter",
          authResult.user.name, authResult.user.email, authResult.user.id.toString(),access_token: authResult.authToken,secret:authResult.authTokenSecret );
